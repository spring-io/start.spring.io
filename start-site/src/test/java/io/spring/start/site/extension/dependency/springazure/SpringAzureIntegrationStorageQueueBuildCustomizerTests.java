...
/**
 * Tests for {@link SpringAzureIntegrationStorageQueueBuildCustomizer}.
 *
 * @author Yonghui Ye
 */
class SpringAzureIntegrationStorageQueueBuildCustomizerTests extends AbstractExtensionTests {

	static final Dependency STORAGE_ADAPTER = Dependency.withId("spring-cloud-azure-starter-integration-storage-queue",
