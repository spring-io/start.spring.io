...
class MavenProjectGenerationConfiguration {
	...
	@Bean
	AnnotationProcessorExclusionBuildCustomizer annotationProcessorExclusionBuildCustomizer(InitializrMetadata metadata,
			ProjectDescription description) {
		return new AnnotationProcessorExclusionBuildCustomizer(metadata, description.getPlatformVersion());
	}
